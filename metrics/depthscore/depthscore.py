...
_KWARGS_DESCRIPTION = """
Computes DepthScore score of a candidate text against one reference text.
Args:
...
class DepthScoreMetric(datasets.Metric):
    def _info(self):
        return datasets.MetricInfo(
            ...
            reference_urls=[
                "https://arxiv.org/abs/2103.12711"
            ],
        )
    ...
    def _compute(self, predictions, references, model_name="bert-base-uncased", layers_to_consider=9,
                 considered_measure='irw', p=None, eps=None, n_alpha=None):
        """
